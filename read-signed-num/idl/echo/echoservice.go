...
type EchoService interface {
	// Parameters:
	//  - Req
	Echo(req *EchoReq) (r *EchoResp, err error)
}
...
// Parameters:
//  - Req
func (p *EchoServiceClient) Echo(req *EchoReq) (r *EchoResp, err error) {
...
func (p *EchoServiceClient) sendEcho(req *EchoReq) (err error) {
...
func (p *EchoServiceClient) recvEcho() (value *EchoResp, err error) {
...
type EchoResult struct {
	Success *EchoResp `thrift:"success,0" json:"success"`
}
...
var EchoResult_Success_DEFAULT *EchoResp

func (p *EchoResult) GetSuccess() *EchoResp {
	if !p.IsSetSuccess() {
